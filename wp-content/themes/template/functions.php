...
function template_scripts() {
	...
	wp_enqueue_style( 'bootstrapmin', get_template_directory_uri() . '/css/bootstrap.min.css',array(),_S_VERSION);
	wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/css/fontawesome.css',array(),_S_VERSION);
	...
	wp_enqueue_style( 'flexslider', get_template_directory_uri() . '/css/flex-slider.css',array(),_S_VERSION);
    ...
    wp_enqueue_script('bootstrapjs', get_template_directory_uri().'/js/bootstrap.bundle.min.js', array(), _S_VERSION, true);
...
// {
//     wp_enqueue_style('template-style', get_stylesheet_uri(), array(), _S_VERSION);
//     wp_enqueue_style('template-style2', get_template_directory_uri().'/css/bootstrap.min.css', array(), _S_VERSION);
//     wp_enqueue_style('template-style3', get_template_directory_uri().'/css/fontawesome.css', array(), _S_VERSION);
//     wp_enqueue_style('template-style4', get_template_directory_uri().'/css/templatemo-stand-blog.css', array(), _S_VERSION);
//     wp_enqueue_style('template-style5', get_template_directory_uri().'/css/owl.css', array(), _S_VERSION);
//     wp_style_add_data('template-style', 'rtl', 'replace');

//     wp_enqueue_script('template-navigation', get_template_directory_uri().'/js/navigation.js', array(), _S_VERSION, true);
//     wp_enqueue_script('jquery', get_template_directory_uri().'/vendor/jquery/jquery.min.js', array(), _S_VERSION, true);
//     wp_enqueue_script('bootstrapjs', get_template_directory_uri().'/vendor/bootstrap/js/bootstrap.bundle.min.js', array(), _S_VERSION, true);
//     wp_enqueue_script('custom', get_template_directory_uri().'/js/custom.js', array(), _S_VERSION, true);
//     wp_enqueue_script('owl', get_template_directory_uri().'/js/owl.js', array(), _S_VERSION, true);
//     wp_enqueue_script('slick', get_template_directory_uri().'/js/slick.js', array(), _S_VERSION, true);
//     wp_enqueue_script('isotope', get_template_directory_uri().'/js/isotope.js', array(), _S_VERSION, true);
//     wp_enqueue_script('accordings', get_template_directory_uri().'/js/accordions.js', array(), _S_VERSION, true);
